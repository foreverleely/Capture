...
//                NSLog(@"-------------->>>>>>>>>>>>>>>>>>>>>>>>>>>>return nil");
    ...
    /**
     *err 利用kEventHotKeyExclusive，返回值不是0的话说明已经有正在运行的程序占用了快捷键组合
     */
    OSStatus err = RegisterEventHotKey([hotKey keyCode], flags, keyID, GetEventDispatcherTarget(), kEventHotKeyExclusive, &carbonHotKey);
